///hg_light_render_static_from_chunks(World, Light, Trunc, MSR Steps, MSR Radius, MSR Fade, MSR Alpha Treshold)
/*
...
hg_light_render_dynamic_from_chunks(argument0,argument1,argument2,argument3,argument4,argument5,argument6);
