///set_behavior_values_raskal()
/*
Sets all behavior and combat variables for AI: Raskal
*/
...
//******************//
    ...
    //Movement:
var __movespeed=4,      // Pixels per step
    __climbspeed=3,   
    __acceleration=0.8,
    ...
    __KBresist=0,       // Knockback resist, 0=0%, 100=100% etc.
    ...
    __allowedLadder=1,    // 1=yes, 0=no
    __hSpeedTreshold=18,
    __vSpeedTreshold=18,
    __eccentricity=5,     // Integer: 0,1,2... - Amount of "randomness" in movement
