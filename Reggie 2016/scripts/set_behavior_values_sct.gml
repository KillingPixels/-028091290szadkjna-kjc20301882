///set_behavior_values_basic()
/*
Sets all behavior and combat variables for AI: Satanic Cat Thing
*/
...
var __movespeed=4,      // Pixels per step
    ...
    __hSpeedTreshold=18,
    __vSpeedTreshold=18,
    __eccentricity=10,    // Integer: 0,1,2... - Amount of "randomness" in movement
