...
switch (spec_str) begin
 ...
 var pos_1;
   ...
   for (i=list_min+1; i<=list_max; i+=1) begin
    ...
    if (i=list_max and pos_1=-1) {
     NSP_notify("SCRIPT: nsp_execute_master. ERROR: Syntax error, execution aborted. ");
     exit;
     }
 ...
 case "with":
   ...
   if nsp_is_equal(b,nspToken[NSP_TOK.abort]) {
    NSP_notify("SCRIPT: nsp_execute_master. ERROR: Execution aborted because evaluation failed.");
    exit;
    }
